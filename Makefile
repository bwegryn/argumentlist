...
# Generated by qmake (3.0) (Qt 5.0.2) on: Sat Oct 4 13:39:58 2014
# Project:  argumentlist.pro
# Template: lib
# Command: /usr/lib/i386-linux-gnu/qt5/bin/qmake -o Makefile argumentlist.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++ -I. -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtXml -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -Wl,-O1 -shared -Wl,-soname,libargumentlist.so.1
LIBS          = $(SUBLIBS) -L/home/brianna/Documents/Kicia_Brianna_hw3/libs2 -lQt5Widgets -L/usr/lib/i386-linux-gnu -lQt5Xml -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
TARGETA       = ../../libs2/libargumentlist.a
...
all: Makefile  ../../libs2/$(TARGET)

../../libs2/$(TARGET):  $(OBJECTS) $(SUBLIBS) $(OBJCOMP)  
	@test -d ../../libs2/ || mkdir -p ../../libs2/
	-$(DEL_FILE) $(TARGET) $(TARGET0) $(TARGET1) $(TARGET2)
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(LIBS) $(OBJCOMP)
	-ln -s $(TARGET) $(TARGET0)
	-ln -s $(TARGET) $(TARGET1)
	-ln -s $(TARGET) $(TARGET2)
	-$(DEL_FILE) ../../libs2/$(TARGET)
	-$(DEL_FILE) ../../libs2/$(TARGET0)
	-$(DEL_FILE) ../../libs2/$(TARGET1)
	-$(DEL_FILE) ../../libs2/$(TARGET2)
	-$(MOVE) $(TARGET) $(TARGET0) $(TARGET1) $(TARGET2) ../../libs2/
...
Makefile: argumentlist.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
distclean: clean
	-$(DEL_FILE) ../../libs2/$(TARGET) 
	-$(DEL_FILE) ../../libs2/$(TARGET0) ../../libs2/$(TARGET1) ../../libs2/$(TARGET2) $(TARGETA)
	-$(DEL_FILE) Makefile
...
argproc.o: argproc.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o argproc.o argproc.cpp
